...
module.exports = message => {
    ...
    if (message.author.id == 235088799074484224 && message.embeds.length !== 0) {
        //console.log(message.embeds);
        //client.channels.resolve('694141760020152382').send('A banned song was played');
        //message.guild.channels.find(channel => channel.name === "logs").send("A banned song was played"); // THIS WORKS
    }
